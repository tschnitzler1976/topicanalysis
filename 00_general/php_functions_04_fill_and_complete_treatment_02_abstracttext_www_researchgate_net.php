		...
		*/
		...
		if($dbnumrowsnull==1){
			...
			$linksforcompletions=$linksforcompletions .
					'<tr>
						<td style="width: 743px; height: 23px;"><a href="../www_researchgate_net/topic_analysis_04_fill_and_complete_treatment_02_abstracttext_all.php?topicanalysisid=' . $topicanalysisid . '&searchresultid=0" target="_blank">Complete the search results for all abstracttexts with the help of "http://www.researchgate.net".</a></td>
						<td>&nbsp;</td>
					</tr><tr>
		...
		if($handle_any_abstracttext==0){
			...
			for($zaehler=0;$zaehler<sizeof($searchstringsids);$zaehler++){
				...
				if(dbnumrows($returndbselect)>0){
					...
					$linksforcompletions=$linksforcompletions .
							'<tr>
								<td style="width: 743px; height: 23px;"><a href="../www_researchgate_net/topic_analysis_04_fill_and_complete_treatment_02_abstracttext_one.php?topicanalysisid=' . $topicanalysisid . '&searchresultid=' . $searchresultid . '" target="_blank">Complete one field for the first links to abstracttext of table "search results".</a></td>
								<td>&nbsp;</td>
							</tr><tr>
								<td style="width: 743px; height: 23px;">&nbsp;</td>
								<td>&nbsp;</td>
