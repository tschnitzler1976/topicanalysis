...
include_once("mysql_db_functions.php");
	...
	function pathtopdffulltext($topicanalysisid,$topicanalysisname,$linksforcompletions){
		...
		if($dbnumrowscount1>0){
			...
			'<tr>
				<td style="width: 743px; height: 23px;"><a href="topic_analysis_04_create_and_complete_treatment_02_path_to_pdffulltext_all.php?topicanalysisid=' . $topicanalysisid . '" target="_blank">Complete the search results for more than one paths to pdffulltexts.</a></td>
				<td>&nbsp;</td>
			</tr><tr>
				...
				if($dbnumrowscount1-$dbnumrowscount2>0){
					...
					$linksforcompletions=$linksforcompletions .
			'<tr>
				<td style="width: 743px; height: 23px;"><a href="topic_analysis_04_create_and_complete_treatment_02_path_to_pdffulltext_one.php?topicanalysisid=' . $topicanalysisid . '" target="_blank">Complete one search result for the path to a pdffulltext.</a></td>
				<td>&nbsp;</td>
			</tr><tr>
				<td style="width: 743px; height: 23px;">&nbsp;</td>
				<td>&nbsp;</td>
