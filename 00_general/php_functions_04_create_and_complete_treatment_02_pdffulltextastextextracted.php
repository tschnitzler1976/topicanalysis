...
include_once("mysql_db_functions.php");
	...
	function pdffulltextastextextracted($topicanalysisid,$topicanalysisname,$linksforcompletions){
		...
		if($dbnumrowscount1>0){
			...
			'<tr>
				<td style="width: 743px; height: 23px;"><a href="topic_analysis_04_create_and_complete_treatment_02_pdffulltext_as_text_extracted_all_01.php?topicanalysisid=' . $topicanalysisid . '" target="_blank">Complete the search results for more than one texts of pdffulltexts that have to be extracted.</a></td>
				<td>&nbsp;</td>
			</tr><tr>
				...
				if($dbnumrowscount1-$dbnumrowscount2>0){
					...
					$linksforcompletions=$linksforcompletions .
			'<tr>
				<td style="width: 743px; height: 23px;"><a href="topic_analysis_04_create_and_complete_treatment_02_pdffulltext_as_text_extracted_one_01.php?topicanalysisid=' . $topicanalysisid . '" target="_blank">Complete one search result for one text of a pdffulltext that has to be extracted.</a></td>
				<td>&nbsp;</td>
			</tr><tr>
				<td style="width: 743px; height: 23px;">&nbsp;</td>
				<td>&nbsp;</td>
