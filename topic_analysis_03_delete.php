...
<body>
<form method="post" action="03_delete/topic_analysis_03_delete_treatment_01.php">

	Select an existing topic analysis to delete<br />
		...
		<tr>
			...
			<table style="width: 71%">
				<tr>
					...
					<td>
<input name="submit_topic_analysis_03_delete" type="submit" value="Delete" class="auto-style1" style="height: 26px" tabindex="2"/></td>
				</tr>
			</table>
			</td>
