...
/*Algorithm:
  0. Select the existing LDA.
  	...
  	1. e) Extract abstracts and optionally pdffulltexts for the scientific articles stored in table lda_id_search_results in files before 
  	1. f) Scan the texts with the help of LDAvis.*/
...
<body>
<form method="post" action="topic_analysis_13_execute_LDA_treatment_01.php">

	Select an existing LDA of topic analysis "' . $topicanalysisname . '" to execute:<br />
		...
		<tr>
			...
			<table style="width: 136%">
				<tr>
					...
					<td>
<input name="submit_topic_analysis_13_execute_LDA" type="submit" value="Select an existing LDA" class="auto-style1" style="height: 26px; width: 182px;" tabindex="2"/></td>
				</tr>
			</table>
			</td>
